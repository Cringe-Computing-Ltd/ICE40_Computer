...
build/$(DESIGN_NAME).json: src/$(DESIGN_NAME).vhd src/VGA_GEN.vhd src/VRAM.vhd src/CRAM.vhd src/CPU.vhd src/MemoryMap.vhd src/RAM.vhd src/Debugger.vhd src/PS2Driver.vhd src/SevenSegment.vhd
